#!/usr/bin/env python
"""
pipywx: tools for python weather on the pi
...
NAME = 'pipywx'
MAINTAINER = "Keen people "
MAINTAINER_EMAIL = "scollis@anl.gov"
DESCRIPTION = DOCLINES[0]
LONG_DESCRIPTION = "\n".join(DOCLINES[2:])
URL = "https://github.com/scollis/pipywx"
DOWNLOAD_URL = "https://github.com/scollis/pipyw"
LICENSE = 'BSD'
...
"""
    ...
    # otherwise the import of pipywx.
...
def configuration(parent_package='', top_path=None):
    ...
    config.add_subpackage('pipywx')
    config.add_data_files(('pipywx', '*.txt'))
